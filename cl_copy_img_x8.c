...
int main()
{
    ...
    {
        #define PROGRAM_FILE "copy_img_x8.cl"
        #define KERNEL_FUNC "copy_img_x8"
        ...
        global_size = (3*608*684/8*sizeof(uint8_t)+local_size-1)/local_size*local_size;
    ...
    stbi_write_bmp("image.bmp", width, height, 3, data_out);
